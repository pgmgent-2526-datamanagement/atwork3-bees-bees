...
export default function ApiaryMap({
  ...
  const [selectedOccurrence, setSelectedOccurrence] =
    useState<GbifOccurrence | null>(null);
  ...
  const isInBloom = (occ: GbifOccurrence): boolean => {
    ...
    if (matchedPlant) {
      ...
      if (matchedPlant.startMonth <= matchedPlant.endMonth) {
        return (
          currentMonth >= matchedPlant.startMonth &&
              ...
              >
                <div
                  style={{
                    width: '14px',
                    height: '14px',
                    backgroundColor: isInBloom(selectedOccurrence)
                      ? '#ff1493'
                      : '#00ff00',
                    borderRadius: '50%',
                    flexShrink: 0,
              ...
              >
                <div
                  style={{
                    ...
                    fontSize: '0.85rem',
                    fontWeight: '600',
                    color: isInBloom(selectedOccurrence)
                      ? '#c2185b'
                      : '#006600',
                ...
                {selectedOccurrence.eventDate && (
                  <p style={{ margin: 0 }}>
                    ...
                    {new Date(selectedOccurrence.eventDate).toLocaleDateString(
                      'nl-BE',
                      {
                        day: 'numeric',
                        month: 'long',
